...
1. 查看当前系统是否有docker相关包，如果有则将其卸载`yum remove XXXXXX`即可
...
4. 安装Docker Engine-Community
   ...
   原因分析：yum 源里面没有这个包`container-selinux` ,可以安装epel源，然后再安装该包即可
...
5. 安装
   ...
   该安装会将最新的版本，Tag为latest，倘若需要执行镜像版本则可以使用以下语句

   `sudo yum install docker-ce-<VERSION_STRING> docker-ce-cli-<VERSION_STRING> containerd.io`

6. 检测安装

   运行`docker run hello-world`看到欢迎词即为安装成功。
